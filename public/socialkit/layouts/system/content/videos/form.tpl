    ...
    <form action="/system/activity/create" method="POST" class="form-horizontal">
        <tpl:condition  data="user.isauthenticated" test="boolean" value="1" >
            <fieldset>
                <div class="control-group">
                    ...
                    <div class="controls fileupload fileupload-new input" data-provides="fileupload">
                        <div class="input-prepend input-append">
                            ...
                            <input type="file" data-label="Select Video" data-target="budkit-uploader" />
                            <div class="btn-group">
                ...
                <div class="control-group">
                    <label class="control-label" for="options[general][site-name]"><tpl:i18n>Description</tpl:i18n></label>
                    <div class="controls">
