                ...
                <div class="control-group">
                    ...
                    <div class="controls fileupload fileupload-new input" data-provides="fileupload">
                        <div class="input-append">
                            <div class="uneditable-input input-xxxlarge"><i class="icon-music fileupload-exists"></i> <span class="fileupload-preview"></span></div><span class="btn btn-file add-on" rel="tooltip" data-original-title="Select File"><span class="fileupload-new"><i class="icon icon-music"></i></span><span class="fileupload-exists" rel="tooltip" data-original-title="Change File"><i class="icon icon-music"></i></span><input type="file" /></span><a href="#" class="fileupload-exists btn add-on" data-dismiss="fileupload" rel="tooltip" data-original-title="Remove"><i class="icon icon-trash"></i></a>
                        </div>
                    </div>
                </div>
                <div class="control-group">
