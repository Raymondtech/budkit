<tpl:layout xmlns="http://www.w3.org/1999/xhtml" xmlns:tpl="http://budkit.org/tpl">
    <div class="navbar navbar-subnav margin-bottom">
        <div class="navbar-inner padding-left-half">
            <ul class="nav" id="accountseditmenu">
                <li class="active"><a data-target="#basicinfo" data-toggle="tab"><i class="icon-info-sign icon icon-16"></i>Basic Information</a></li> 
                <li><a data-target="#localization" data-toggle="tab"><i class="icon-globe icon icon-16"></i>Localization</a></li>
                <li><a data-target="#password" data-toggle="tab"><i class="icon-key icon icon-16"></i>Password</a></li> 
                <li><a data-target="#api" data-toggle="tab"><i class=" icon-plus-sign-alt icon icon-16"></i>API</a></li>
            </ul>
        </div>
    </div>
