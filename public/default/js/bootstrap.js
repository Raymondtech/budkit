...
!function( $ ){
    ...
    Checkbox.prototype = {
        ...
        toggle: function ( e ) {
            var $this = $(this)
            , selector = '[data-selector="'+$this.attr('data-check')+'"]'
    ...
    $.fn.checkbox = function ( option ) {
        return this.each(function () {
            ...
            if (!data) $this.data('checkbox', (data = new Checkbox(this)))
    ...
    $(function () {
        $('body').on('click.checkbox.data-api', tick, Checkbox.prototype.toggle)
    })
