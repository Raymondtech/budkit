<tpl:layout xmlns="http://www.w3.org/1999/xhtml" xmlns:tpl="http://budkit.org/tpl">
    <div class="workspace-head">
        <ul class="nav icon-tabs left no-margin no-bottom-border docked-bottom">
            ...
            <li><a href="#files" data-toggle="tab"><i class="icon-paper-clip icon icon-16"></i>Files</a></li>
            <li><a href="#reports" data-toggle="tab"><i class="icon-file-rich icon icon-16"></i>Reports</a></li>
            <li><a href="#contacts" data-toggle="tab"><i class="icon-people icon icon-16"></i>Contacts</a></li>
        </ul>
    </div>
