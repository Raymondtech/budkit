<tpl:layout xmlns="http://www.w3.org/1999/xhtml" xmlns:tpl="http://budkit.org/tpl">
    <div class="container-startup signup">
        <form class="form-vertical margin-bottom-zero" name="form" method="post"  action="/sign-up">
            
            <div class="startup-alternatives top">
            ...
            <div class="startup-body">
                ...
                <div class="control-group heading background-${tempauth.provider}">
                    <label class="control-label margin-bottom-half"><strong><tpl:element type="text" formatting="sprintf" cdata="Hello %s" data="tempauth.name" /></strong><span class="help-inline"><tpl:element type="text" formatting="sprintf" cdata="(@%s) " data="tempauth.nickname" /></span><a href="/system/authenticate/login/cleartemp:1/" class="pull-right" >Not You?</a> </label>
                    ...
                    <input name="user_${tempauth.provider}_uid" value="${tempauth.uid}" type="hidden" />
                    <input name="user_${tempauth.provider}_token" value="${tempauth.token}" type="hidden" />
                </div>
            </tpl:condition>
                <tpl:condition test="boolean" data="config|general.site-allow-registration" value="1">
                    <tpl:condition test="boolean" data="config|general.site-inviteonly" value="0">
                        <div class="row-fluid">
                            <div class="control-group span6">
                                ...
                                <div class="controls">
                                    <input class="span12 focused" id="first_name" name="user_first_name" value="${tempauth.first_name}" type="text" placeholder="First Name" />
                                </div>
                            </div>
                            <div class="control-group span6">
                                <label class="control-label" for="user_last_name"><tpl:i18n>Last Name</tpl:i18n><em class="mandatory">*</em></label>
                                <div class="controls">
                                    <input class="span12 focused" id="last_name" name="user_last_name" value="${tempauth.last_name}" type="text" placeholder="Last Name" />
                                </div>
                            </div>
                        </div>
                        <div class="control-group row-fluid">
                            ...
                            <div class="controls">
                                <input class="span12 focused" id="user_email" name="user_email" value="${tempauth.email}" type="text" placeholder="<?php echo _('e.g john.doe@example.com'); ?>" />
                            </div>
                        </div>
                        <div class="row-fluid">
                            <div class="control-group span6">
                                ...
                                <div class="controls">
                                    <input class="span12 focused" id="user_name_id" name="user_name_id" type="text" value="${tempauth.nickname}" placeholder="JohnDoe1976" />
                                </div>
                            </div>
                            <div class="control-group span6">
                    ...
                    <div class="form-actions margin-bottom-zero padding-bottom-zero">
                        <div class="btn-group">
