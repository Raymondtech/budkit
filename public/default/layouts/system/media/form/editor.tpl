<tpl:layout xmlns="http://www.w3.org/1999/xhtml" xmlns:tpl="http://budkit.org/tpl">
    <form action="/system/media/timeline/create" class="no-margin" method="POST" enctype="multipart/form-data">
        <fieldset class="no-bottom-margin">
            ...
            <div class="controls row-fluid margin-top-half margin-bottom-zero">           
                <input type="text" name="media_summary" placeholder="Title (Optional) " class="span12 margin-bottom-zero" value="${media_summary}" />
            </div>
