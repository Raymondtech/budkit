<tpl:layout xmlns="http://www.w3.org/1999/xhtml" xmlns:tpl="http://tuiyo.co.uk/tpl">
    <div id="control-panel">
        <div class="row-fluid text-centered clearfix"> 
            ...
            <a href="/content/photo/create" class="thumbnail-icon text-centered" data-original-title="Upload Photos" rel="tooltip">
                <i class="icon icon-32 icon-camera-retro icon-block"></i>
            </a>
            <a href="/content/event/create" class="thumbnail-icon text-centered" data-original-title="Create Event" rel="tooltip">
                <i class="icon icon-32 icon-calendar icon-block"></i>
            </a>
            <a href="/content/question/create" class="thumbnail-icon text-centered" data-original-title="Ask Question" rel="tooltip">
            ...
            <a href="/content/location/checkin" class="thumbnail-icon text-centered" data-original-title="New Check-In" rel="tooltip">
