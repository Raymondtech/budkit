        ...
        <tpl:condition data="workspaces.items" test="isset" value="1">
            <div class="widget">
                <div class="widget-head">
                    <span class="widget-title">Workspaces</span>
                    <tpl:condition data="workspaces.items" test="isset" value="1">
                        <ul class="nav nav-pills  pull-right nav-mediagrid no-margin" id="workspaces-gridtoggler">
                        ...
                        <tpl:loop data="workspaces.items" id="project-lists">
                            <li class="mgrow-fluid">   
                                <div class="mgitem project-description mgcol5">
                                    <a href="/campus/workspaces/workspace:${object_uri}/overview">
