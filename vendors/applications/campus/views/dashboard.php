 ...
 * ˙
 */
final class Dashboard extends \Platform\View{
    ...
    /**
     * Adds widgets to the start dashboard
     * 
     * @param type $action
     */
    public static function startWidgets(&$action){
        
        //@TODO check that they have permissions to access the task manager;
        //$action->output->addToPosition("dashwidgets", "Task Manager Widgets");
