...
final class Schema extends Platform\Model {
    ...
    private static function createMenutable() {
        ...
        static::$database->query(
                ...
                (7, 0, 'Network', '/system/admin/network/index', '', 7, 2, 'link', '', 13, 26, 1),
                (8, 7, 'Members', '/system/admin/network/members/lists', '', 8, 2, 'link', '', 14, 25, 1),
                (9, 7, 'Permissions', '/system/admin/network/authorities', '', 9, 2, 'link', '', 15, 24, 1),
                (10, 7, 'Relationships', '/system/admin/network/relationships', '', 10, 2, 'link', '', 16, 23, 1),
                (11, 7, 'Analytics', '/system/admin/network/analytics', '', 11, 2, 'link', '', 17, 22, 1),
                (2, 7, 'Moderation', '/system/admin/content/moderation', '', 2, 2, 'link', NULL, 18, 21, 1),
                (12, 7, '%{ext:network}', '/system/admin/network', '', 12, 2, 'method', 'lookup', 19, 20, 1),
                (19, 0, 'Settings', '/system/admin/settings/configuration', '', 19, 2, 'link', '', 37, 48, 1),
                (20, 19, 'Configuration', '/system/admin/settings/configuration', '', 20, 2, 'link', '', 38, 47, 1),
                (21, 19, 'Appearance', '/system/admin/settings/appearance', '', 21, 2, 'link', '', 39, 46, 1),
                (22, 19, 'Maintenance', '/system/admin/settings/maintenance', '', 22, 2, 'link', '', 40, 45, 1),
                (23, 19, 'Navigation', '/system/admin/settings/navigation', '', 23, 2, 'link', '', 41, 44, 1),
                (24, 19, '%{ext:settings}', '/system/admin/settings/:application', '', 24, 2, 'method', 'lookup', 42, 43, 1),
                (25, 0, 'Extensions', '/system/admin/extensions/index', '', 25, 1, 'link', '', 49, 50, 1),
                (32, 0, 'Account Information', '/member/settings/account', '', 0, 2, 'link', NULL, 1, 2, 1),
                (33, 0, 'Edit Profile', '/member/settings/profile', NULL, 0, 2, 'link', NULL, 3, 4, 1),
                ...
                (38, 0, 'Timeline', '/member/profile/display/timeline', NULL, 0, 5, 'link', NULL, 1, 2, 0),
                ...
                (43, 0, 'Timeline', '/system/timeline/stream', NULL, 0, 3, 'link', NULL, 1, 2, 1),
                (44, 0, 'Content', '/system/content/gallery', NULL, 0, 3, 'link', NULL, 3, 4, 1),
