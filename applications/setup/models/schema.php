...
final class Schema extends Platform\Model {
    ...
    private static function createMenutable() {
        ...
        static::$database->query(
                ...
                (36, 77, 'Locations', '/settings/system/permissions/locations', '', 9, 2, 'link', '', 4, 7, 1),
                (35, 77, 'Add Rules', '/settings/system/permissions/add', '', 9, 2, 'link', '', 5, 6, 1),
                (79, 0, 'System', '', '', 19, 2, 'link', '', 1, 14, 1),
                (80, 79, 'Configuration', '/settings/system/configuration', '', 20, 2, 'link', '', 2, 13, 1),
                (34, 79, 'Sever', '/settings/system/server', '', 20, 2, 'link', '', 3, 12, 1),
                (33, 79, 'Input', '/settings/system/input', '', 20, 2, 'link', '', 4, 11, 1),
                (32, 79, 'Localization', '/settings/system/localization', '', 20, 2, 'link', '', 5,10, 1),
                (31, 79, 'Extension', '/settings/system/extensions', '', 20, 2, 'link', '', 6, 9, 1),
                (30, 79, 'Emails', '/settings/system/emails', '', 20, 2, 'link', '', 7, 8, 1),
                (81, 0, 'Appearance', '', '', 21, 2, 'link', '', 1, 10, 1),
                (29, 81, 'Themes', '/settings/system/themes', '', 21, 2, 'link', '', 2, 9, 1),
                (28, 81, 'Settings', '/settings/system/settings', '', 21, 2, 'link', '', 3, 8, 1),
                (27, 81, 'Widgets', '/settings/system/widgets', '', 21, 2, 'link', '', 3, 7, 1),             
                (26, 81, 'Navigation', '/settings/system/navigation', '', 23, 2, 'link', '', 5, 6, 1),
