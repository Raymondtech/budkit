...
final class Schema extends Platform\Model {
    ...
    private static function createMenutable() {
        ...
        static::$database->query(
                ...
                (66, 65, 'Repository', '/system/extension/repository', NULL, 0, 3, 'link', NULL, 2, 3, 1),
                (72, 0, 'Personal', '', NULL, 0, 2, 'link', NULL, 1, 10, 1),
                ...
                (77, 0, 'Network', '', NULL, 0, 2, 'link', NULL, 1, 10, 1),
                ...
                (36, 77, 'Add Permission', '/settings/system/permissions/add/permission', '', 9, 2, 'link', '', 4, 7, 1),
                (35, 77, 'Add Authority', '/settings/system/permissions/add/authority', '', 9, 2, 'link', '', 5, 6, 1),
                (79, 0, 'System', '', '', 19, 2, 'link', '', 1, 14, 1),
                (80, 79, 'Configuration', '/settings/system/configuration', '', 20, 2, 'link', '', 2, 13, 1),
                (34, 79, 'Sever', '/settings/system/configuration/server', '', 20, 2, 'link', '', 3, 12, 1),
                (33, 79, 'Input', '/settings/system/configuration/input', '', 20, 2, 'link', '', 4, 11, 1),
                (32, 79, 'Localization', '/settings/system/configuration/localization', '', 20, 2, 'link', '', 5,10, 1),
                (31, 79, 'Extension', '/settings/system/configuration/extensions', '', 20, 2, 'link', '', 6, 9, 1),
                (30, 79, 'Emails', '/settings/system/configuration/emails', '', 20, 2, 'link', '', 7, 8, 1),
                (81, 0, 'Appearance', '', '', 21, 2, 'link', '', 1, 10, 1),
                (29, 81, 'Themes', '/settings/system/appearance/themes', '', 21, 2, 'link', '', 2, 9, 1),
                (28, 81, 'Settings', '/settings/system/appearance/settings', '', 21, 2, 'link', '', 3, 8, 1),
