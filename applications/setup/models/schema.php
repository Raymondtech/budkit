    ...
    private static function createMenutable(){
        ...
        static::$database->query(
             "INSERT INTO `?menu` (`menu_id`, `menu_parent_id`, `menu_title`, `menu_url`, `menu_classes`, `menu_order`, `menu_group_id`, `menu_type`, `menu_callback`, `lft`, `rgt`, `menu_iscore`) VALUES
                ...
                (2, 0, 'Content Manager', '/system/admin/content/lists', '', 2, 1, 'link', NULL, 3, 12, 1),
                (3, 2, 'All Stories', '/system/admin/content/lists/stories', ' ', 3, 1, 'link', NULL, 4, 11, 1),
                (4, 2, 'All Photos', '/system/admin/content/lists/photos', ' ', 4, 1, 'link', NULL, 5, 10, 1),
                (5, 2, 'All Locations', '/system/admin/content/lists/locations', ' ', 5, 1, 'link', NULL, 6, 9, 1),
                (6, 2, '%{ext:contentlist}', '/system/admin/content/lists/:application', ' ', 6, 1, 'method', 'lookup', 7, 8, 1),
                (7, 0, 'Network Manager', '/system/admin/network/index', '', 7, 1, 'link', '', 13, 24, 1),
                (8, 7, 'All Members', '/system/admin/network/members/lists', '', 8, 1, 'link', '', 14, 23, 1),
                (9, 7, 'Access control', '/system/admin/network/authorities', '', 9, 1, 'link', '', 15, 22, 1),
                ...
                (13, 0, 'Platform Manager', '/system/admin/manage', NULL, 13, 1, 'link', '', 25, 36, 1),
                (14, 13, 'Manage Categories', '/system/admin/manage/categories', '', 14, 1, 'link', '', 26, 35, 1),
                (15, 13, 'Manager Groups', '/system/admin/manage/groups', '', 15, 1, 'link', '', 27, 34, 1),
                (16, 13, 'Edit Custom Types', '/system/admin/manage/fields', '', 16, 1, 'link', '', 28, 33, 1),
                (17, 13, 'Edit Emails', '/system/admin/manage/emails', '', 17, 1, 'link', '', 29, 32, 1),
                (18, 13, '%{ext:extensionlist}', '/system/admin/manage/:extensions', '', 18, 1, 'method', 'lookup', 30, 31, 1),
                (19, 0, 'Settings & Configurations', '/system/admin/settings/configuration', '', 19, 1, 'link', '', 37, 48, 1),
                (20, 19, 'System Preferences', '/system/admin/settings/configuration', '', 20, 1, 'link', '', 38, 47, 1),
                (21, 19, 'Appearance Settings', '/system/admin/settings/appearance', '', 21, 1, 'link', '', 39, 46, 1),
                (22, 19, 'Maintenance Settings', '/system/admin/settings/maintenance', '', 22, 1, 'link', '', 40, 45, 1),
                (23, 19, 'Navigation Settings', '/system/admin/settings/navigation', '', 23, 1, 'link', '', 41, 44, 1),
                (24, 19, '%{ext:settings}', '/system/admin/settings/:application', '', 24, 1, 'method', 'lookup', 42, 43, 1),
                (25, 0, 'Extensions Manager', '/system/admin/extensions/index', '', 25, 1, 'link', '', 49, 56, 1),
                (26, 25, 'Installed extensions', '/system/admin/extensions/installed', '', 26, 1, 'link', '', 50, 55, 1),
                (27, 25, 'Extension repositories', '/system/admin/extensions/repositories', '', 27, 1, 'link', '', 51, 54, 1),
                (28, 25, 'Add extension', '/system/admin/extensions/add', '', 28, 1, 'link', '', 52, 53, 1),
                (29, 0, 'Enabled Applications', '/system/admin/applications/index', '', 29, 1, 'link', '', 56, 61, 1),
                (30, 29, 'System', '/system/admin/applications/master', '', 30, 1, 'link', '', 57, 60, 1),
                (31, 29, '%{ext:applications}', '/system/admin/applications/', '', 31, 1, 'method', 'lookup', 58, 59, 1),
                ...
                (38, 0, 'Activity', '/member/profile/view/activity', NULL, 0, 5, 'link', NULL, 1, 2, 0),
                (39, 0, 'About Me', '/member/profile/view/about', NULL, 0, 5, 'link', NULL, 3, 4, 0),
                (40, 0, 'Achievements', '/member/profile/view/achievements', NULL, 0, 5, 'link', NULL, 5, 6, 0),
                (41, 0, 'Pilgrimage', '/member/profile/view/pilgrimage', NULL, 0, 5, 'link', NULL, 9, 10, 0),
                (42, 0, 'Dashboard', '/system/start/dashboard', NULL, 0, 3, 'link', NULL, 1, 2, 1),
                (43, 0, 'Activity', '/system/start/dashboard/activity', NULL, 0, 3, 'link', NULL, 3, 4, 1),
                (44, 0, 'Photos', '/system/start/dashboard/photos', NULL, 0, 3, 'link', NULL, 5, 6, 1),
