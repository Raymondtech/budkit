...
final class Schema extends Platform\Model {
    ...
    private static function createMenutable() {
        ...
        static::$database->query(
                ...
                (7, 0, 'Network', '/system/admin/network/index', '', 7, 1, 'link', '', 13, 26, 1),
                (8, 7, 'Members', '/system/admin/network/members/lists', '', 8, 1, 'link', '', 14, 25, 1),
                (9, 7, 'Permissions', '/system/admin/network/authorities', '', 9, 1, 'link', '', 15, 24, 1),
                (10, 7, 'Relationships', '/system/admin/network/relationships', '', 10, 1, 'link', '', 16, 23, 1),
                (11, 7, 'Analytics', '/system/admin/network/analytics', '', 11, 1, 'link', '', 17, 22, 1),
                (2, 7, 'Moderation', '/system/admin/content/reported', '', 2, 1, 'link', NULL, 18, 21, 1),
                (12, 7, '%{ext:network}', '/system/admin/network', '', 12, 1, 'method', 'lookup', 19, 20, 1),
